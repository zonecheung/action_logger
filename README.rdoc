...
In your controller:
  ...
  log_request :only => [:index, :show]          # Logs only :index and :show actions.
  log_request :except => [:index, :show]        # Logs all actions except :index and :show.
  log_request :method => [:post]                # Logs only POST call.
  log_request :none            ]                # Logs nothing in current controller.
