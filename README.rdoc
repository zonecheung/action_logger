...
In your controller:
  ...
  log_request :only => [:index, :show]          # Log only :index and :show actions.
  log_request :except => [:index, :show]        # Log all actions except :index and :show.
  log_request :method => [:post]                # Log only POST call.
